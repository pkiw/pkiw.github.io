...
<table width="100%">
 <tr>
    <td width="50%"><p style="font-size:22px">The capacity to generate large amounts of image data raises the need of ways to store it. An optimal soultion for this is reposite your data in existing databases that are dedicated for longevity and are connected to global diversity initiatives. The citizen-science gallery of Nordic Microalgae (https://nordicmicroalgae.org/gallery/Citizen%20science/) is such a repository. This concept has been made possible through collaborations with the local online resource Nordic Microalgae, being maintained by Swedish Meteorological and Hydrological Institute and Swedish Biodiversity Data Infrastructure (SBDI). In turn, SBDI is a part of the Global Biodiversity Information Facility, making sure the collected data ends up in relevant repositories.</p>
</td>
